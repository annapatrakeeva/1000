...
r1_guide=0.545
r2_guide=0.6323
be_mat=openmc.Material(name='be', temperature=554.15)
be_mat.add_element('Be', 1.0)
be_mat.set_density('g/cm3',1.848 )

E110_mat=openmc.Material( name='E110_mat', temperature=554.15)
...
E635_mat=openmc.Material( name='E635_mat', temperature=554.15)
...
steel_mat=openmc.Material(material_id=4, name='steel_mat', temperature=554.15)
...
Dy2O3TiO2_mat=openmc.Material(material_id=5, name='Dy2O3TiO2_mat', temperature=554.15)
...
B4C_mat=openmc.Material(name='B4C_mat', temperature=554.15)
...
class AbstractUO2():
    def __init__(self, enr, density=10.4):
        mat = openmc.Material(material_id=random.randint(100,10000), name=f'UO2_{enr:.1f}',  temperature=554.15)
...
UO2_37_mat=openmc.Material(temperature=554.15)
...
UO2_36_mat=openmc.Material(temperature=554.15)
...
water_mat=openmc.model.borated_water(1098,  density=0.7235)
water_mat.temperature=554.15

#print(water_mat.get_nuclide_atom_densities())
water_mat1=openmc.Material(name='water_mat', temperature=554.15)
...
basket_mat.temperature=554.15

Gd2O3_mat=openmc.Material(temperature=554.15)
